            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">Manage Vendors</h2>
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="index.php">Home</a>
                                    </li>
                                    <li class="breadcrumb-item active">Manage Vendors
                                    </li>
                                </ol>
                            </div>
                        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#addVendorForm').on('submit', function(e) {
                ...
                $.ajax({
                    url: API_BASE_URL + 'Laravel/api/inventory/store-vendor',
                    type: 'POST',
                    data: {
            ...
            $('#updateVendorForm').on('submit', function(e) {
                ...
                $.ajax({
                    url: API_BASE_URL + 'Laravel/api/inventory/update-vendor/' + id,
                    type: 'POST',
                    data: {
                        name: $('#name').val(),
            ...
            $(document).on('click', '.btn-delete', function() {
                ...
                $.ajax({
                    url: API_BASE_URL + 'Laravel/api/inventory/delete-vendor/' + id,
                    type: 'POST',
                    success: function() {
