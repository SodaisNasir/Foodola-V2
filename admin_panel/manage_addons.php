                                ...
                                <tbody>
                                      ...
                                      while($row = mysqli_fetch_array($result)){
                                          ...
                                          echo "<tr>";
                                            echo "<td>{$sn}</td>";
                                            echo "<td>{$row['id']}</td>";
                                            echo "<td name='tittlename'>{$row['product_id']}</td>";
                                           
                                            echo "<td name='subname'>{$row['product_name']}</td>";
                                            echo "<td name='cost'>{$row['addon_name']}</td>";
                                            echo "<td name='price'>{$row['addon_price']}</td>";
                                          ...
                                          echo '<td><button  onclick="openAddMore(\''. $row['id'] .'\' ,\''.$row['product_name'].'\' ,\''.$row['addon_name'].'\' ,\''.$row['addon_price'].'\')">Update</button>';"
                                             </td>";
                                          echo "</tr>";
                                          $index++;
                                      }
        ...
        <h2>Update Addons</h2>
         ...
         <form method="POST" action="phpfiles/insertions.php" enctype="multipart/form-data">
             ...
             <div class="col-sm-12">
                 ...
                 <div class="form-group">
                    <div class="controls">
                        <input class="form-control"  value="" type="text" name="Addon_name" id="Addon_name" placeholder="Enter Addon Name" > 
                    </div>
                  </div>
                  
                  <div class="form-group">
                    <div class="controls">
                        <input class="form-control"  value="" type="number" name="Addon_price" id="Addon_price" placeholder="Enter Addon Price" > 
                    </div>
                  </div>
...
function openAddMore(id,proname,subname,cost){


      document.getElementById('Addon_name').value = subname;
      document.getElementById('Addon_price').value = cost;
