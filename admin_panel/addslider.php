...
if(isset($_GET['Massage'])){
    if($_GET['Massage'] == 'Sucessfully added new slider.'){
       echo "<script>alert('Sucessfully added new slider.')</script>";
       header("Refresh: 1; url='addslider.php'");
        ...
        <div class="content-header row">
          <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
              <div class="col-12">
                <h2 class="content-header-title float-left mb-0">Add Slider Image</h2>
