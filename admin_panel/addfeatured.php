        ...
        <div class="content-header row">
          <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
              <div class="col-12">
                <h2 class="content-header-title float-left mb-0">Add Featured Product</h2>
                <div class="breadcrumb-wrapper col-12">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.php">Home</a>
                    </li>
                    <li class="breadcrumb-item active">Add New Featured Product
                    </li>
                  </ol>
                </div>
              </div>
		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-header"> 
					<h4 class="card-title">New Featured Product</h4>
				</div>
				<div class="card-content">
                    ...
                    <div class="controls">
                      ...
                      <div class="col-sm-12">
							...
							<button type="Submit" name="btnSubmit_insertFeaturedProduct"  class="btn btn-primary">Submit</button>
						</form>
					</div>
				</div>
			</div>
