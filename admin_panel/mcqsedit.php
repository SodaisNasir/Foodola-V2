        ...
        <div class="content-header row">
          <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
              <div class="col-12">
                <h2 class="content-header-title float-left mb-0">Add Mcq's</h2>
                <div class="breadcrumb-wrapper col-12">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.php">Home</a>
                    </li>
                    <li class="breadcrumb-item active">Add New Mcq's
                    </li>
                  </ol>
                </div>
              </div>
          ...
          <form class="form-horizontal" action="phpfiles/insertions.php" method="POST" enctype="multipart/form-data">
              ...
              <!--  <div class="col-sm-6">
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                    <div class="controls">
                      <select name="mcqsQuesType" class="custom-select"  onchange="Changefunction(this.value,'question')">
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                    <div class="controls"  id="text_for_question">
                      <input type="text" name="mcqsQuesText" class="form-control" placeholder="Mcq's Question">
                    </div>

                     <div  class="controls"  id="image_for_question" style="display: none">
                      <input type="file" name="mcqsQuesImg" class="form-control" placeholder="Mcq's Question">
                    </div>
                  </div>
                </div>
                  ...
                  <div class="form-group">
                    <div class="controls">
                       <select name="mcqsOptionType" class="custom-select" onchange="Changefunction(this.value,'option1')">
                            <option selected value="text">Text</option> 
                            <option value="image">Image</option>   
              ...
              <div class="controls"  id="text_for_option1">
                      <input type="text" name="textOption1" class="form-control" placeholder="Option 1">
                    </div>

                     <div  class="controls"  id="image_for_option1" style="display: none">
                      <input type="file" name="imgOption1" class="form-control" placeholder="Option 1">
                    </div>
                  </div>
                </div>
                 ...
                 <div class="col-sm-6">
                  <div class="form-group">
              <div class="controls"   id="text_for_option2">
                      <input type="text" name="textOption2" class="form-control" placeholder="Option 2">
                    </div>

                     <div  class="controls"  id="image_for_option2" style="display: none">
                      <input type="file" name="imgOption2" class="form-control" placeholder="Option 2" >
                    </div>
                  </div>
                </div>
                 ...
                 <div class="col-sm-6">
                  <div class="form-group">
              <div class="controls"   id="text_for_option3">
                      <input type="text" name="textOption3" class="form-control" placeholder="Option 3">
                    </div>

                     <div  class="controls"  id="image_for_option3" style="display: none">
                      <input type="file" name="imgOption3" class="form-control" placeholder="Option 3">
                    </div>
                  </div>
                </div>
                ...
                <div class="col-sm-6">
                  <div class="form-group">
              <div class="controls"   id="text_for_option4">
                      <input type="text" name="textOption4" class="form-control" placeholder="Option 4">
                    </div>

                     <div  class="controls"  id="image_for_option4" style="display: none">
                      <input type="file" name="imgOption4" class="form-control" placeholder="Option 4">
                    </div>
                  </div>
                </div>
                  ...
                  <div class="form-group">
                    <div class="controls">
                      <select name="subcatId" class="form-control" >
                        <option disabled selected value="">Select Category id</option>
                        <?php
                          $sql = "SELECT `sub_category_id`, `sub_category_name` FROM `tbl_sub_categories`";
            ...
            <!--  </div> -->
              <button type="Submit" name="EnterMcqs"  class="btn btn-primary">Submit</button>
            </form>
          </div>
        </div>
      </div>
