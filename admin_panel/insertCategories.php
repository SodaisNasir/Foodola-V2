...
if(isset($_POST['btnSubmit'])){
      ...
      if(empty($errors)==true){
         move_uploaded_file($file_tmp,"images/".$imageNewName.".$file_ext");
          $imageURL = "images/".$imageNewName.".".$file_ext;
          $sql = "INSERT INTO `tbl_products`(`category_id`, `product_name`, `product_description`, `product_cost`, `product_price`, `product_sku`, `image_1`, `image_2`, `image_3`, `image_4`, `image_5`) VALUES ($ProCat,'$ProName','$ProDes',$ProCost,$ProPrice,'$ProSKU','$imageURL','$imageURL', '$imageURL', '$imageURL' , '$imageURL')";
          $result = mysqli_query($con,$sql);
          if($result){
              echo "<script>alert('Image Uploaded Sucessfully.')</script>";
              header('Location: insertEbook.php?Massage=Succesfully uploaded');
          }
      }else{
         print_r($errors);
      }
        ...
        <div class="content-header row">
          <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
              <div class="col-12">
                <h2 class="content-header-title float-left mb-0">Create new category</h2>
							...
							<div class="row">
								<div class="col-sm-6">
									<div class="form-group">
										<div class="controls">
											<input type="text" name="Cat_name" class="form-control" placeholder="Categoey Name" required
												data-validation-required-message="This First Name field is required">
										</div>
									</div>
								</div>
							</div>
							<button type="submit" name="btnSubmit_insertCategories" class="btn btn-primary">Submit</button>
						</form>
					</div>
				</div>
			</div>
