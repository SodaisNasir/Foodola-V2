...
if(isset($_GET['Massage'])){
    if($_GET['Massage'] == 'Sucessfully Updated Privacy'){
       echo "<script>alert('Sucessfully Updated Privacy')</script>";
       header("Refresh: 1; url='addprivacypolicy.php'");
        ...
        <div class="content-header row">
          <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
              <div class="col-12">
                <h2 class="content-header-title float-left mb-0">Add Privacy Policy</h2>
							...
							<div class="form-group">
								<div class="controls">
                                   <div class="controls">
                                    ...
                                    $sql="SELECT `id`, `privacy` FROM `privacy_policy`";
                                   ...
                                   <input type="hidden" name="id" class="form-control" value=<?php echo $row['id'] ?> placeholder="Category Image" required="">    
                                                       <textarea id="editor" name="privacy"><?php echo htmlspecialchars($row['privacy']); ?></textarea>
                                   <?php } ?>
       ...
       <!--                             </div>-->
    			...
    			<!--    	</div>-->
                      <div class="col-sm-12">
							...
							<button type="Submit" name="btnSubmit_privacypolicy"  class="btn btn-primary">Submit</button>
						</form>
					</div>
				</div>
			</div>
