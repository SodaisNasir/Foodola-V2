                ...
                <form method="post" class="row g-3">
                  ...
                  <div class="col-md-6">
                    ...
                    <input
                      ...
                      name="ios_link"
                      class="form-control"
                      value="<?php echo htmlspecialchars($settings['ios_link']); ?>"
                  ...
                  <div class="col-md-6">
                    ...
                    <input
                      ...
                      name="android_link"
                      class="form-control"
                      value="<?php echo htmlspecialchars($settings['android_link']); ?>"
                  ...
                  <div class="col-md-6">
                    ...
                    <input
                      ...
                      class="form-control"
                      min="1"
                      value="<?php echo htmlspecialchars($settings['duration_minutes']); ?>"
                      placeholder="e.g. 30">
                  </div>
                  ...
                  <div class="col-md-6">
                    ...
                    <select name="report_lang" class="form-select">
                      <option value="en" <?php if ($settings['report_lang'] == "en") echo "selected"; ?>>
                        English
                      </option>
                      <option value="de" <?php if ($settings['report_lang'] == "de") echo "selected"; ?>>
                        German
                      </option>
                    </select>
                  </div>
