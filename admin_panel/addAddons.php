                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Add Addons
                                    </li>
                                </ol>
                            </div>
                        </div>
											...
											<input type="Number" name="" class="form-control" placeholder="Quiz title" >
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            <div class="controls">
                                                                <input type="text" name="addon_title" class="form-control" placeholder="Addon Title" required="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-sm-12">
                                                    <button type="button" name="add" id="add" class="btn btn-primary mb-5">Create Addon</button>
                                                </div>
