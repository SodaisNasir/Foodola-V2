        ...
        <div class="content-header row">
          <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
              <div class="col-12">
                <h2 class="content-header-title float-left mb-0">Riders</h2>
                <div class="breadcrumb-wrapper col-12">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.php">Home</a>
                    </li>
                    <li class="breadcrumb-item active">Riders
                    </li>
                  </ol>
                </div>
              </div>
                            ...
                            <table id="example" class="table">
                                <thead>
                                  ...
                                  <tbody>
                                      ...
                                      $sql="SELECT `id`,`name`, `email`, `user_referal`, `phone`, `amount` ,  `sbscription_status` FROM `users` WHERE `role_id` =2";
                                      ...
                                      while($row = mysqli_fetch_array($result)){
                                          echo "<tr>";
                                            ...
                                            echo "<td name='sbscription_status'>{$row['sbscription_status']} </td>";
                                             echo "<td><button onclick='openAddMore({$row['id']},$index)' class='btn btn-primary' >Update Status</button>
                                             </td>";
                                          echo "</tr>";
                                          $index++;
                                      }
...
<!-- 
       ...
       <button type="submit" name="btnUpdateRiderStatus" class="btn btn-primary">Update</button>
       </form>
      </div>
...
var modal_Add = document.getElementById("myModal_Add");
 ...
 function openAddMore(id,index){
     ...
     document.getElementById('status').value = document.getElementsByName('sbscription_status')[index].innerText;
