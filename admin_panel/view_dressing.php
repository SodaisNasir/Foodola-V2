        ...
        <div class="content-header row">
          <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
              <div class="col-12">
                <h2 class="content-header-title float-left mb-0">View Dressing</h2>
                <div class="breadcrumb-wrapper col-12">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.html">Home</a>
                    </li>
                    <li class="breadcrumb-item active">View Dressing
                    </li>
                  </ol>
                </div>
              </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">View Dressing</h4>
                </div>
                        ...
                        <div class="table-responsive">
                            <table id="example" class="table">
                                ...
                                <tbody>
                                      ...
                                      $sql="SELECT `dressing_id`, `dressing_title`, `dressing_title_user` FROM `dressing_list`";
