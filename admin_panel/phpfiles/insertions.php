...
if (isset($_POST['btn_update_table'])) {
    ...
    if (!empty($_FILES["table_image"]["name"])) {
        ...
        // Validate file size
        if ($_FILES["table_image"]["size"] > 500000) {
    ...
    if (!empty($tbl_img)) {
        ...
        $sql = "UPDATE `tables` SET `table_name`='$tbl_name', `seats`='$tbl_seats', `status`='$tbl_status', `table_image`='$tbl_img' WHERE `id`='$tbl_id'";
    } else {
        // Update without modifying table_image if no image is uploaded
        $sql = "UPDATE `tables` SET `table_name`='$tbl_name', `seats`='$tbl_seats', `status`='$tbl_status' WHERE `id`='$tbl_id'";
    }
...
$sql = "INSERT INTO `tables`(`table_name`, `seats`, `table_image`, `branch_id`,`status`, `created_at`, `updated_at`) 
        VALUES ('$table_name', '$table_seats', '$table_image', '$branch_id', 'available', NOW(), NOW())";
            ...
            if ($row_email) {
                ...
                $mail = new PHPMailer(true);
                   ...
                   try {
                        ...
                        $mail->setFrom('support@jbpizza.de', 'Jb Pizza');
                       ...
                       $mail->Subject = "Ihre Bestellung wurde angenommen";
                        ...
                        <html>
                        <head>
                            <title>Ihre Bestellung wurde angenommen – Jb Pizza</title>
                        ...
                        <body>
                            <table width="100%" cellpadding="0" cellspacing="0" style="background-image: url(\'https://jbpizza.foodola.shop/API/uploads/email_backgroundd.jpg\'); background-size: cover; padding: 20px; background-position: center;">
                                <tr>
                                    <td align="center">
                                        <table width="100%" class="content" style="max-width: 600px;">
                                            <tr>
                                                <td align="center">
                                                    <img src="https://jbpizza.foodola.shop/admin_panel/images/logo.png" alt="Jb Pizza" style="width: 100px; margin-bottom: 20px;">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    ...
                                                    <p>Vielen Dank für Ihre Bestellung bei <strong>Jb Pizza</strong>.</p>
                                                    ...
                                                    <p>Mit freundlichen Grüßen,<br>Ihr Jb Pizza Team</p>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
...
<html>
<head>
    <title>Ihre Bestellung wurde geliefert – Jb Pizza</title>
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@400;600&display=swap" rel="stylesheet">
    <style>
        body {
            font-family: "Poppins", Arial, sans-serif;
                ...
                <table width="100%" class="content" style="max-width: 600px;">
                    ...
                    <tr>
                        <td>
                            ...
                            <p><strong>Bestellnummer:</strong> #' . htmlspecialchars($order_id) . '</p>
                            <h3>Guten Appetit!</h3>
                            <p>Wir hoffen, dass Sie Ihr Essen genießen. Vielen Dank, dass Sie bei <strong>Jb Pizza</strong> bestellt haben.</p>
