            ...
            if ($row_email) {
                ...
                $mail = new PHPMailer(true);
                   ...
                   try {
                        ...
                        $mail->setFrom('support@chickpom.de', 'Chick Pom');
                       ...
                       $mail->Subject = "Ihre Bestellung wurde angenommen";
                        ...
                        <html>
                        <head>
                            <title>Ihre Bestellung wurde angenommen – Chick Pom</title>
                                ...
                                <tr>
                                    <td align="center">
                                        <table width="100%" class="content" style="max-width: 600px;">
                                            <tr>
                                                <td align="center">
                                                    <img src="https://chickpom.de/admin_panel/images/logo.png" alt="Pizza Burger Point" style="width: 100px; margin-bottom: 20px;">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    ...
                                                    <p>Vielen Dank für Ihre Bestellung bei <strong>Chick Pom</strong>.</p>
                                                    ...
                                                    <p>Mit freundlichen Grüßen,<br>Ihr Chick Pom Team</p>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
...
<html>
<head>
    <title>Ihre Bestellung wurde geliefert – Chick Pom</title>
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@400;600&display=swap" rel="stylesheet">
    <style>
        body {
            font-family: "Poppins", Arial, sans-serif;
                ...
                <table width="100%" class="content" style="max-width: 600px;">
                    ...
                    <tr>
                        <td>
                            ...
                            <p><strong>Bestellnummer:</strong> #' . htmlspecialchars($order_id) . '</p>
                            <h3>Guten Appetit!</h3>
                            <p>Wir hoffen, dass Sie Ihr Essen genießen. Vielen Dank, dass Sie bei <strong>Chick Pom</strong> bestellt haben.</p>
