                ...
                $mail = new PHPMailer(true);
                   ...
                   try {
                       ...
                       $mail->Subject = "Ihre Bestellung wurde angenommen";
                        ...
                        <html>
                        <head>
                            <title>Ihre Bestellung wurde angenommen – Super Pizza</title>
                                ...
                                <tr>
                                    <td align="center">
                                        <table width="100%" class="content" style="max-width: 600px;">
                                            <tr>
                                                <td align="center">
                                                    <img src="https://superpizza.foodola.shop/admin_panel/images/logo.png" alt="Super Pizza" style="width: 100px; margin-bottom: 20px;">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    ...
                                                    <p>Vielen Dank für Ihre Bestellung bei <strong>Super Pizza</strong>.</p>
                                                    ...
                                                    <p>Mit freundlichen Grüßen,<br>Ihr Super Pizza Team</p>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
            ...
            if ($row_user) {
                ...
                if ($row_email) {
                    ...
                    try {
                        ...
                        <html>
                        <head>
                            <title>Ihre Bestellung wurde geliefert – Super Pizza</title>
                            <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@400;600&display=swap" rel="stylesheet">
                            <style>
                                body {
                                    font-family: "Poppins", Arial, sans-serif;
                                ...
                                <tr>
                                    <td align="center">
                                        <table width="100%" class="content" style="max-width: 600px;">
                                            <tr>
                                                <td align="center">
                                                    <img src="https://superpizza.foodola.shop/admin_panel/images/logo.png" alt="Foodola" style="width: 100px; margin-bottom: 20px;">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    ...
                                                    <p><strong>Bestellnummer:</strong> #' . htmlspecialchars($order_id) . '</p>
                                                    <h3>Guten Appetit!</h3>
                                                    <p>Wir hoffen, dass Sie Ihr Essen genießen. Vielen Dank, dass Sie bei <strong>Super Pizza</strong> bestellt haben.</p>
