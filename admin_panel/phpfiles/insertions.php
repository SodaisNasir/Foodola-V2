            ...
            if ($row_email) {
                ...
                $mail = new PHPMailer(true);
                   ...
                   try {
                        ...
                        $mail->setFrom('support@foodvibe.de', 'foodvibe');
                       ...
                       $mail->Subject = "Ihre Bestellung wurde angenommen";
                        ...
                        <html>
                        <head>
                            <title>Ihre Bestellung wurde angenommen – foodvibe</title>
                                ...
                                <tr>
                                    <td align="center">
                                        <table width="100%" class="content" style="max-width: 600px;">
                                            <tr>
                                                <td align="center">
                                                    <img src="https://foodvibeka.de/admin_panel/images/logo.png" alt="Pizza Burger Point" style="width: 100px; margin-bottom: 20px;">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    ...
                                                    <p>Vielen Dank für Ihre Bestellung bei <strong>Foodvibe</strong>.</p>
                                                    ...
                                                    <p>Mit freundlichen Grüßen,<br>Ihr Foodvibe Team</p>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
...
<html>
<head>
    <title>Ihre Bestellung wurde geliefert – Foodvibe</title>
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@400;600&display=swap" rel="stylesheet">
    <style>
        body {
            font-family: "Poppins", Arial, sans-serif;
        ...
        <tr>
            <td align="center">
                <table width="100%" class="content" style="max-width: 600px;">
                    <tr>
                        <td align="center">
                            <img src="https://foodvibeka.de/admin_panel/images/logo.png" alt="foodvibeka" style="width: 100px; margin-bottom: 20px;">
                        </td>
                    </tr>
                    <tr>
                        <td>
                            ...
                            <p><strong>Bestellnummer:</strong> #' . htmlspecialchars($order_id) . '</p>
                            <h3>Guten Appetit!</h3>
                            <p>Wir hoffen, dass Sie Ihr Essen genießen. Vielen Dank, dass Sie bei <strong>Food Vibe</strong> bestellt haben.</p>
                            <p>Wenn Sie Fragen haben oder Feedback geben möchten, stehen wir Ihnen jederzeit zur Verfügung.</p>
                            <p>Mit freundlichen Grüßen,<br>Ihr Food Vibe Team</p>
                        </td>
                    </tr>
                </table>
            </td>
