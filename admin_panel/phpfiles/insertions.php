                ...
                $mail = new PHPMailer(true);
                   ...
                   try {
                       ...
                       $mail->Subject = "Ihre Bestellung wurde angenommen";
                        ...
                        <html>
                        <head>
                            <title>Ihre Bestellung wurde angenommen – Burger Planet</title>
                        ...
                        <body>
                            <table width="100%" cellpadding="0" cellspacing="0" style="background-image: url(\'http://burgerplanet-ka.de/API/uploads/email_backgroundd.jpg\'); background-size: cover; padding: 20px; background-position: center;">
                                <tr>
                                    <td align="center">
                                        <table width="100%" class="content" style="max-width: 600px;">
                                            <tr>
                                                <td align="center">
                                                    <img src="http://burgerplanet-ka.de/admin_panel/images/logo.png" alt="Burger Planet" style="width: 100px; margin-bottom: 20px;">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    ...
                                                    <p>Vielen Dank für Ihre Bestellung bei <strong>Burger Planet</strong>.</p>
                                                    ...
                                                    <p>Mit freundlichen Grüßen,<br>Ihr Burger Planet Team</p>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
...
<html>
<head>
    <title>Ihre Bestellung wurde geliefert – Burger Planet</title>
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@400;600&display=swap" rel="stylesheet">
    <style>
        body {
            font-family: "Poppins", Arial, sans-serif;
                ...
                <table width="100%" class="content" style="max-width: 600px;">
                    ...
                    <tr>
                        <td>
                            ...
                            <p><strong>Bestellnummer:</strong> #' . htmlspecialchars($order_id) . '</p>
                            <h3>Guten Appetit!</h3>
                            <p>Wir hoffen, dass Sie Ihr Essen genießen. Vielen Dank, dass Sie bei <strong>Burger Planet</strong> bestellt haben.</p>
