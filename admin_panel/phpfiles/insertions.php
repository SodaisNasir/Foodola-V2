                ...
                $mail = new PHPMailer(true);
                   ...
                   try {
                       ...
                       $mail->Subject = "Ihre Bestellung wurde angenommen";
                        ...
                        <html>
                        <head>
                            <title>Ihre Bestellung wurde angenommen – Pizza Sofort</title>
                                ...
                                <tr>
                                    <td align="center">
                                        <table width="100%" class="content" style="max-width: 600px;">
                                            <tr>
                                                <td align="center">
                                                    <img src="https://pizzasofort-ka.de/admin_panel/images/logo.png" alt="Pizza Sofort" style="width: 100px; margin-bottom: 20px;">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    ...
                                                    <p>Vielen Dank für Ihre Bestellung bei <strong>Pizza Sofort</strong>.</p>
...
<html>
<head>
    <title>Ihre Bestellung wurde geliefert – Pizza Sofort</title>
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@400;600&display=swap" rel="stylesheet">
    <style>
        body {
            font-family: "Poppins", Arial, sans-serif;
        ...
        <tr>
            <td align="center">
                <table width="100%" class="content" style="max-width: 600px;">
                    <tr>
                        <td align="center">
                            <img src="https://pizzasofort-ka.de/admin_panel/images/logo.png" alt="Pizza Burger Point" style="width: 100px; margin-bottom: 20px;">
                        </td>
                    </tr>
                    <tr>
                        <td>
