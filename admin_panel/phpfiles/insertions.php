                                ...
                                <tr>
                                    <td align="center">
                                        <table width="100%" class="content" style="max-width: 600px;">
                                            <tr>
                                                <td align="center">
                                                    <img src="https://xn--pizzablitzstringen-m3b.de/pizza_blitz/admin_panel/images/logo.png" alt="Pizza Blitz" style="width: 100px; margin-bottom: 20px;">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    ...
                                                    <p>Vielen Dank für Ihre Bestellung bei <strong>Pizza Blitz</strong>.</p>
                                                    ...
                                                    <p>Mit freundlichen Grüßen,<br>Ihr Pizza Blitz Team</p>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
...
<html>
<head>
    <title>Ihre Bestellung wurde geliefert – Pizza Blitz</title>
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@400;600&display=swap" rel="stylesheet">
    <style>
        body {
            font-family: "Poppins", Arial, sans-serif;
                ...
                <table width="100%" class="content" style="max-width: 600px;">
                    ...
                    <tr>
                        <td>
                            ...
                            <p><strong>Bestellnummer:</strong> #' . htmlspecialchars($order_id) . '</p>
                            <h3>Guten Appetit!</h3>
                            <p>Wir hoffen, dass Sie Ihr Essen genießen. Vielen Dank, dass Sie bei <strong>Pizza Blitz</strong> bestellt haben.</p>
