                                  ...
                                  <tbody>
                                     ...
                                     $status = 'Active';        
                                      while($row = mysqli_fetch_array($result)){
                                          ...
                                          echo "<tr>";
                                            echo "<td>$count</td>";
                                            echo "<td name='area_name'>{$row['area_name']}</td>";
                                            echo "<td name='min_order_amount'>{$row['min_order_amount']}</td>";
                                            echo "<td name='is_disable'>{$status}</td>";
                                            
                                            $branch_id = $row['branch_id'];
                                            $sql_branch = "SELECT * FROM `users` WHERE id='$branch_id'";
                                            $exec_sql_branch = mysqli_query($conn, $sql_branch);
                                            $data = mysqli_fetch_array($exec_sql_branch);
                                                
                                            echo "<td name='name'>{$data['name']}</td>";
                                            echo '<td><button class="btn btn-primary" onclick="openAddMore(\''. $row['id'] .'\'  , \''.$row['area_name'].'\' ,  \''.$row['min_order_amount'].'\')">Update</button>
                                             </td>';
                                          echo "</tr>";
                                          $index++;
                                          $count++;
    ...
    <div id="myModal_Add" class="modal">
      ...
      <div class="modal-content-Updated">
        ...
        <h2>Update Area</h2>
         ...
         <form method="POST" action="assets/Actions.php" enctype="multipart/form-data">
         <input hidden type="text" name="areaid">  
            <div class="col-sm-12">
                <div class="form-group">
                    <div class="controls">
                        <input class="form-control"  value="" type="text" name="areaname" id="areaname" placeholder="Enter Area Name" required> 
                    </div>
                </div>

                <div class="form-group">
                    <div class="controls">
                        <input class="form-control" value="" type="number" name="minprice" id="minprice" placeholder="Enter min price" required> 
                    </div>
                </div>
            ...
            <div class="col-md-6 my-4">
                          <div class="controls">
                            <select name="branch_id" id="userSelect" class="form-control">
       ...
       <button type="submit" name="btnUpdateRiderStatus" class="btn btn-primary ml-3">Update</button>
       </form>
      </div>
...
var modal_Add = document.getElementById("myModal_Add");
 ...
 function openAddMore(id,area_name,min_order_amount){
