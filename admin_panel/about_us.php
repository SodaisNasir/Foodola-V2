		...
		<div class="col-md-12">
			<div class="card">
				...
				<div class="card-content">
							...
							<div class="form-group">
								<div class="controls">
                                   <div class="controls">
                                       ...
                                       $sql="SELECT  `about` ,`id` FROM `about_us`";
                    ...
                    <textarea id="editor" name="about"><?php echo htmlspecialchars($row['about']); ?></textarea>
...
const editor = Jodit.make('#editor', {
    ...
    toolbarAdaptive: false
                      ...
                      <div class="col-sm-12">
							...
							<button type="Submit" name="btnSubmit_aboutUs"  class="btn btn-primary">Submit</button>
						</form>
					</div>
				</div>
			</div>
