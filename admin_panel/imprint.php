...
if(isset($_GET['Massage'])){
    if($_GET['Massage'] == 'Sucessfully Updated'){
       echo "<script>alert('Sucessfully Updated')</script>";
       header("Refresh: 1; url='imprint.php'");
        ...
        <div class="content-header row">
          <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
              <div class="col-12">
                <h2 class="content-header-title float-left mb-0">Add Imprint</h2>
		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title">Add Imprint</h4>
				</div>
							...
							<div class="form-group">
								<div class="controls">
                                   <div class="controls">
                                       ...
                                       $sql="SELECT  `imprint` ,`id` FROM `imprint`";
                                       ...
                                       ?>
                                        ...
                                        <input type="hidden" name="id" class="form-control" value=<?php echo $row['id'] ?> placeholder="Category Image" required="">
                                                <textarea id="editor" name="imprint"><?php echo htmlspecialchars($row['imprint']); ?></textarea>
...
const editor = Jodit.make('#editor', {
    ...
    toolbarAdaptive: false
                      ...
                      <div class="col-sm-12">
							...
							<button type="Submit" name="btnSubmit_imprint"  class="btn btn-primary">Submit</button>
						</form>
					</div>
				</div>
			</div>
