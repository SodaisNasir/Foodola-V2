                        ...
                        <div class="table-responsive">
                            <table id="example" class="table">
                                ...
                                <tbody>
                                      ...
                                      $sql="SELECT `id`,`name`, `email`, `user_referal`, `phone`, `amount` ,  `sbscription_status` FROM `users` WHERE `role_id` =3 ORDER BY `name` ASC";
                                      ...
                                      while($row = mysqli_fetch_array($result)){
                                          echo "<tr>";
                                            ...
                                            echo "<td name='sbscription_status'>{$row['sbscription_status']} </td>";
                                           echo "<td><button class='btn btn-primary' onclick='openAddMore({$row['id']},$index,{$row['amount']},{$row['sbscription_status']},{$row['user_referal']})' >Update Status</button>
                                             </td>";
                                          echo "</tr>";
                                          $index++;
                                      }
        ...
        <h2>Update Rider status</h2>
         ...
         <input hidden type="text" name="user_id">  
             <div class="col-sm-12">
                    ...
                    <div class="controls">
                     <select name="status" id="status"  class="form-control">
                            <option selected disabled>Select Rider Status</option> 
                            <option value="1">Active</option>   
                            <option value="0">Suspended</option>   
                       </select>
                    </div>
                  </div> 
                  <input class="form-control"  value="" type="hidden" name="user_referal" id="user_referal" placeholder="Enter user name" required>
                  <div class="form-group">
                    <div class="controls">
                        <input class="form-control"  value="" type="text" name="amount_for_referred_user" id="amount_for_referred_user" placeholder="Enter user name" hidden> 
                    </div>
                  </div>
...
var modal_Add = document.getElementById("myModal_Add");
 ...
 function openAddMore(id,index,amount,status,referal){
    
     
     document.getElementById('status').value = status;
     document.getElementById('user_referal').value = referal;
     document.getElementById('amount_for_referred_user').value = amount;
