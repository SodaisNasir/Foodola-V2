...
<section id="basic-datatable">
    ...
    <div class="row">
        ...
        <di
        .-
*-58        <input type="text" id="myInput" class="search" onkeyup="myFunctionx()" placeholder="Search for names.." title="Type in a name">
                        ...
                        <div class="col-md-4 col-sm-6" >
                            <div class="card  card-block">
                             ...
                             <!--For Addon List-->
                                    <?php 
                                  include_once('connection.php');
                                  $addon = "SELECT `as_id`, `ao_id`,`ao_title`, `as_name`, `as_price` FROM `addon_sublist` WHERE `ao_id` = '$addon_id' ";
                                  ...
                                  ?>
                                        <div class="row ml-2">
                                            ...
                                            <?php echo "<input type='checkbox' name='checkboxid{$addon_id}' value='{$rowx['as_id']},{$rowx['as_name']},{$rowx['as_price']}' />"; ?>
                                            <?php echo $rowx['as_name'] ?> <label style='margin-left:15px'> €<?php echo $rowx['as_price'] ?></label>
                                            </label>
                                        </div>
                                <?php } ?>  
                               </div>    
                               ...
                               <?php 
                               include_once('connection.php');
                               $type_title = "SELECT `type_id`, `type_title`, `type_title_user` FROM `types_list` WHERE `type_id` = '$type_id'";
                               $resultz = mysqli_query($conn,$type_title);
                               $name_of_items = mysqli_num_rows($resultz);
                               if($name_of_items > 0){
                                   $arr = mysqli_fetch_array($resultz);
                               echo '<p style="margin-left:25px" class="cardtitle">'.$arr[2].'</p>';
                               }
                               ?>
                               
                                <div class="row ml-2">
                                  <label for="checkid"  style="word-wrap:break-word;font-size:11px;margin-top : 10px;">
                                      <!--<input name="checkid"  type="checkbox" value="test" />-->
                                        <select name='checkboxid{$type_id}' class="form-control w-100">
                                            <option>Select</option>
                               
                                 <?php 
                                  include_once('connection.php');
                                  $type_sublist = "SELECT `ts_id`,`ts_name` FROM `types_sublist`";
                                  $resultxz = mysqli_query($conn,$type_sublist);
                                  $no_of_items = mysqli_num_rows($resultxz);
                                  if($no_of_items > 0)
                                  {
                                      ?>
                                        <div class="scroll"> 
                                      <?php
                                         while($rowx = mysqli_fetch_array($resultxz))
                                         {
                                             ?>
                                              <option value='{$rowx['ts_id']},{$rowx['ts_name']}'><?php echo $rowx['ts_name'] ?></option>
                                            <?php
                                 ...
                                 <?php echo $rowx['ts_name'] ?> <label style='margin-left:15px'></label>
                                    </label>
                                </div>  
                               ...
                               <?php 
                               include_once('connection.php');
                               $dressing_list = "SELECT `dressing_title_user` FROM `dressing_list` WHERE `dressing_id` = '$dressing_id'";
                               $resultxyz = mysqli_query($conn,$dressing_list);
                               $name_of_items = mysqli_num_rows($resultxyz);
                               if($name_of_items > 0){
                                   $dressing_arr = mysqli_fetch_array($resultxyz);
                               echo '<p style="margin-left:25px" class="cardtitle">'.$dressing_arr[0].'</p>';
                            //   echo $dressing_arr[2];
                            //   die();
                               }
                               ?>
                                 <?php 
                                  include_once('connection.php');
                                  $dressing_sublist = "SELECT `ds_id`,`dressing_name` FROM `dressing_sublist`";
                                  $resultzyx = mysqli_query($conn,$dressing_sublist);
                                  $no_of_items = mysqli_num_rows($resultzyx);
                                  if($no_of_items > 0){
                                      ?>
                                       <?php } ?>
                                       <div class="scroll"> 
                                       <?php
                                  foreach($resultzyx as $rowx){
                                  ?>
                                        <div class="row ml-2">
                                            <label for="checkid"  style="word-wrap:break-word;font-size:11px;">
                                            <!--<input name="checkid"  type="checkbox" value="test" />-->
                                            <?php echo "<input type='checkbox' name='checkboxid{$type_id}' value='{$rowx['ds_id']},{$rowx['dressing_name']}' />"; ?>
                                            <?php echo $rowx['dressing_name'] ?> <label style='margin-left:15px'></label>
                                            </label>
                                        </div>
                                <?php } ?>  
                               </div>  
