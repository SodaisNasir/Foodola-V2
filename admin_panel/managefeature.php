...
<?php
  ...
  if(isset($_GET['Massage'])){
      if($_GET['Massage'] == 'Sucessfully updated product.'){
         ...
         header("Refresh: 1; url='manageproducts.php'");
       }else{
        ...
        <div class="content-header row">
          <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
              <div class="col-12">
                <h2 class="content-header-title float-left mb-0">Manage Featured Products</h2>
                <div class="breadcrumb-wrapper col-12">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.html">Home</a>
                    </li>
                    <li class="breadcrumb-item active">Manage Featured Products
                    </li>
                  </ol>
                </div>
              </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Manage Featured Products</h4>
                </div>
                                ...
                                <tbody>
                                      ...
                                      while($row = mysqli_fetch_array($result)){
                                          ...
                                          echo "<tr>";
                                            ...
                                            echo "<td name='cost'>{$row['cost']}</td>";
                                            echo "<td name='price'>{$row['price']}</td>";
                                            echo "<td name='discount'>{$row['discount']}</td>";
                                            echo "<td name='qty'>{$row['qty']}</td>";
                                            echo "<td name='description'>{$row['description']}</td>";
                                          echo "<td><button onclick='openAddMore({$row['id']},{$index})' >Update</button>
                                                    <button onclick='openimagemodel({$row['id']},{$index})' >Update Image</button>
                                             </td>";
                                          echo "</tr>";
                                          $index++;
                                      }
...
<div id="myModal" class="modal">
    ...
    <div id="myModal_Add" class="modal">
      ...
      <div class="modal-content-Updated">
         ...
         <form method="POST" action="phpfiles/insertions.php" enctype="multipart/form-data">
             ...
             <div class="col-sm-12">
                 <input class="form-control"  value="" type="text" name="product_id" id="product_id" placeholder="Enter user name" hidden> 
                  ...
                  <div class="form-group">
                    <div class="controls">
                        <input class="form-control"  value="" type="text" name="ProDes" id="ProDes" placeholder="Enter product description" > 
                    </div>
                  </div>
                  
                  <div class="form-group">
                    <div class="controls">
                        <input class="form-control"  value="" type="number" name="ProCost" id="ProCost" placeholder="Enter Cost" > 
                    </div>
                  </div>
                  
                  <div class="form-group">
                    <div class="controls">
                        <input class="form-control"  value="" type="number" name="ProPrice" id="ProPrice" placeholder="Enter Price" > 
                    </div>
                  </div>
                  
                  <div class="form-group">
                    <div class="controls">
                        <input class="form-control"  value="" type="number" name="ProDis" id="ProDis" placeholder="Enter Discount" > 
                    </div>
                  </div>
       ...
       <button type="submit" name="updatefeaturedProduct" class="btn btn-primary">Save</button>
       </form>
      </div>
...
var modal_Add = document.getElementById("myModal_Add");
 ...
 function openAddMore(id,subid,index){
// id
// tittlename
// cost
// price
...
// description
 modal_Add.style.display = "block";
      document.getElementById('ProName').value = document.getElementsByName('tittlename')[index].innerHTML;
      document.getElementById('ProCost').value = document.getElementsByName('cost')[index].innerHTML;
      document.getElementById('ProPrice').value = document.getElementsByName('price')[index].innerHTML;
      document.getElementById('ProDis').value = document.getElementsByName('discount')[index].innerHTML;
      document.getElementById('ProDes').value = document.getElementsByName('description')[index].innerHTML;
