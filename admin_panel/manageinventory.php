...
<?php
  ...
  if(isset($_GET['Massage'])){
      if($_GET['Massage'] == 'Sucessfully updated inventory.'){
         echo "<script>alert('Sucessfully updated inventory.')</script>";
         header("Refresh: 1; url='manageinventory.php'");
       }else{
              ...
              <div class="col-12">
                ...
                <div class="breadcrumb-wrapper col-12">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Manage Inventory
                    </li>
                  </ol>
                </div>
              </div>
                        ...
                        <div class="table-responsive">
                            <table id="example" class="table">
                                ...
                                <tbody>
                                      ...
                                      $sql="SELECT `id`, `sub_category_id`, `name`, `description`, `cost`, `price`, `discount`, `qty`, `created_at`, `updated_at` FROM `products`";
                                      ...
                                      while($row = mysqli_fetch_array($result)){
                                          ...
                                          echo "<td><button class='btn btn-primary' onclick='openAddMore({$row['id']},{$row['qty']})' >Update</button>
                                             </td>";
                                          echo "</tr>";
                                          $index++;
                                      }
...
<div id="myModal" class="modal">
    ...
    <div id="myModal_Add" class="modal">
      ...
      <div class="modal-content-Updated">
         ...
         <form method="POST" action="phpfiles/insertions.php" enctype="multipart/form-data">
             ...
             <div class="col-sm-12">
                 <input class="form-control"  value="" type="text" name="product_id" id="product_id" placeholder="Enter user name" hidden> 
                  ...
                  <div class="form-group">
                    <div class="controls">
                        <input class="form-control" value="" type="number" name="newqty" required  placeholder="Enter qty" > 
                    </div>
                  </div>
       ...
       <button type="submit" name="updateInventory" class="btn btn-primary">Save</button>
       </form>
      </div>
