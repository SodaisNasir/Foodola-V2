                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Manage Products Timing
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Manage Products Timing</h4>
                                    <button class="btn btn-primary" data-toggle="modal" data-target="#addTableModal">Add Schedule</button>
                                </div>
                                ...
                                <div class="card-content">
                                    <div class="card-body card-dashboard">
                                        ...
                                        <tbody class="text-center">
                                            ...
                                            $sql = "SELECT * FROM `product_timings`";
                                            ...
                                            while ($row = mysqli_fetch_array($result)) {
                                                ...
                                                echo "<tr>";
                                                echo "<td>{$sn}</td>";
                                                echo "<td name='timing_name'>{$timingName}</td>";
                                                echo "<td name='start_time'>{$startTime}</td>";
                                                echo "<td name='end_time'>{$endTime}</td>";
                                                ...
                                                echo "<td class='text-center'>
                                                        <div class='d-flex justify-content-center gap-2'>
                                                            ...
                                                            <form action='phpfiles/insertions.php' method='POST' class='m-0 p-0'>
                                                                ...
                                                                <button type='submit' name='btn_delete_time' class='btn btn-danger'
                                                                    onclick='return confirm(\"Are you sure you want to delete this Time ?\")'>
                                                                    Delete
                                                                </button>
                                                            </form>
                                                        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="phpfiles/insertions.php" method="POST">
                    ...
                    <button type="submit" name="btn_update_pro_timing" class="btn btn-primary w-100">Update Timing</button>
...
<div class="modal fade" id="AddTableModal" tabindex="-1" role="dialog" aria-labelledby="updateDealModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="AddTableModal">Add Timing</h5>
                            ...
                            <!-- Timing Name -->
                            <div class="form-group">
                                <label for="timing_name">Timing Name</label>
                                <input type="text" class="form-control" id="timing_name" name="timing_name" required>
                            </div>
                            ...
                            <button type="submit" name="btn_insert_pro_timing" class="btn btn-primary w-100">Add Time </button>
