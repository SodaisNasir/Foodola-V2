...
<?php
  ...
  if(isset($_GET['Massage'])){
      if($_GET['Massage'] == 'Sucessfully updated amount.'){
         ...
         header("Refresh: 1; url='managePoints.php'");
       }else{
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Manage Credit</h4>
                </div>
      ...
      <div class="modal-content-Updated">
        ...
        <h2>Points for customer</h2>
         ...
         <form method="POST" action="phpfiles/insertions.php" enctype="multipart/form-data">
             ...
             <div class="col-sm-12">
                 <input class="form-control"  value="" type="text" name="user_id" id="user_id" placeholder="Enter user name" hidden> 
