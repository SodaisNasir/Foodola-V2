  ...
  <div class="row g-5">
    <div class="col-md-12">
      ...
      <article class="blog-post">
        <h2 class="blog-post-title">Data protection</h2>
        <h3>General note and mandatory information </h3>
        <h3>Naming of the responsible body </h3>
        <p>The responsible body for data processing on this website is: </p>

        <p>Kohinoor Indian Curry home service. The responsible body decides alone or together with others on the purposes and means of processing personal data (e.g. names, contact details, etc.). </p>
     

        <h3 class="mb-3">Revocation of your consent to data processing.</h3>
        <p>Some data processing operations are only possible with your express consent. You can revoke your consent that you have already given at any time. An informal message by e-mail is sufficient for the revocation. The legality of the data processing that took place up until the revocation remains unaffected by the revocation. </p>
        
        <h3>Right to lodge a complaint with the competent supervisory authority.</h3>
        <p>As a data subject, you have the right to lodge a complaint with the competent supervisory authority in the event of a breach of data protection law. The competent supervisory authority with regard to data protection issues is the state data protection officer of the federal state in which our company is based. The following link provides a list of data protection officers and their contact details: https://www.bfdi.bund.de/DE/Infothek/Anschriften_Links/anschriften_links-node.html . </p>
        ...
        <h3>Data transmission upon conclusion of the contract for the purchase and shipment of goods </h3>
        
        <p>Personal data will only be transmitted to third parties if there is a need for the execution of the contract. Third parties can be payment service providers or logistics companies, for example. A further transmission of the data does not take place or only if you have expressly consented to this. 

The basis for data processing is Art. 6 Paragraph 1 lit. b GDPR, which allows the processing of data to fulfill a contract or pre-contractual measures. </p>

<h3>Registration on this site </h3>
<p>You can register on our website to use certain functions. The transmitted data is used exclusively for the purpose of using the respective offer or service. Mandatory information requested during registration must be provided in full. Otherwise we will refuse the registration. 
...
We store the data collected during registration during the period that you are registered on our website. Your data will be deleted if you cancel your registration. Statutory retention periods remain unaffected. </p>


<h3>contact form </h3>
<p>Data transmitted via the contact form will be stored, including your contact details, in order to be able to process your request or to be available for follow-up questions. This data will not be passed on without your consent. 
...
Data transmitted via the contact form will remain with us until you ask us to delete it, revoke your consent to storage or there is no longer any need for data storage. Mandatory legal provisions - in particular retention periods - remain unaffected. </p>


<h3>Newsletter Data </h3>
<p>To send our newsletter, we need an e-mail address from you. It is necessary to verify the e-mail address provided and to consent to receiving the newsletter. Additional data is not collected or is voluntary. The data is used exclusively for sending the newsletter. 
...
Data entered to set up the subscription will be deleted if you unsubscribe. If this data has been transmitted to us for other purposes and elsewhere, it will remain with us. </p>

<h3>cookies </h3>

<p>Our website uses cookies. These are small text files that your web browser stores on your end device. Cookies help us to make our offer more user-friendly, effective and secure. 
...
The setting of cookies, which are necessary to carry out electronic communication processes or to provide certain functions you want (e.g. shopping cart), takes place on the basis of Article 6 Paragraph 1 Letter f GDPR. As the operator of this website, we have a legitimate interest in the storage of cookies for the technically error-free and smooth provision of our services. If other cookies are set (e.g. for analysis functions), they will be treated separately in this data protection declaration. </p>

<h3>Google Analytics </h3>
<p>Our website uses functions of the web analysis service Google Analytics. The provider of the web analysis service is Google Inc., 1600 Amphitheater Parkway, Mountain View, CA 94043, USA. 
