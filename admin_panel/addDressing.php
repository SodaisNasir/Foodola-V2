...
if(isset($_GET['Massage'])){
    if($_GET['Massage'] == 'Sucessfully added new Dressing.'){
       echo "<script>alert('Sucessfully added new Dressing.')</script>";
       header("Refresh: 1; url='addDressing.php'");
        ...
        <div class="content-header row">
          <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
              <div class="col-12">
                <h2 class="content-header-title float-left mb-0">Add Dressing</h2>
                <div class="breadcrumb-wrapper col-12">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.php">Home</a>
                    </li>
                    <li class="breadcrumb-item active">Add Dressing
                    </li>
                  </ol>
                </div>
              </div>
		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title">New Dressing</h4>
				</div>
					...
					<form class="form-horizontal" action="phpfiles/insertions.php" method="POST" enctype="multipart/form-data">
						...
						<div class="col-sm-6">
							<div class="form-group">
								<div class="controls">
                                   <div class="controls">
                                   <input type="text" name="dressing_title" class="form-control" placeholder="Dressing Title" required="">
                                    </div>
    							</div>
    						</div>
    			    	</div>
						...
						<div class="col-sm-12">
							<button type="button" name="add" id="add"    class="btn btn-primary mb-5">Create Dressing</button>
    			    	</div>
                ...
                <div class="col-sm-12">
							<button type="Submit" name="btnSubmit_insertDressing"  class="btn btn-primary">Submit</button>
                </div>
