                 ...
                 <div class="col-sm-6">
                  <div class="form-group">
                    <div class="controls"   id="text_for_option3">
                      <input type="number" name="phone" class="form-control" placeholder="User Phone" required="">
                    </div>
                  </div>
                </div>
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                    <div class="controls"   id="text_for_option4">
                      <input type="Password" name="passwrod" class="form-control" placeholder="User Password" required="">
                    </div>
                  </div>
                </div>
