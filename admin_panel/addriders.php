...
if(isset($_GET['Massage'])){
    if($_GET['Massage'] == 'Sucessfully added new product.'){
       ...
       header("Refresh: 1; url='addnewProduct.php'");
        ...
        echo "<script>alert('Rider has been added successfully.')</script>";
     }
        ...
        <div class="content-header row">
          <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
              <div class="col-12">
                <h2 class="content-header-title float-left mb-0">Add Rider</h2>
                <div class="breadcrumb-wrapper col-12">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.php">Home</a>
                    </li>
                    <li class="breadcrumb-item active">Add New Rider
                    </li>
                  </ol>
                </div>
              </div>
	...
	<div class="row">
		<div class="col-md-12">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title">New Rider</h4>
				</div>
    			...
    			<!--    	<div class="col-sm-6">-->
							...
							<!--	<div class="controls">-->
       <!--                            <div class="controls">-->
       <!--                            <input type="text" name="ProDes" class="form-control" placeholder="Short Email" required="">-->
       <!--                             </div>-->
    			<!--				</div>-->
    			<!--			</div>-->
    			<!--    	</div>-->
    			    	...
    			    	<div class="col-sm-6">
							<div class="form-group">
								<div class="controls">
                                   <div class="controls">
                                   <input type="text" name="email" class="form-control" placeholder="Rider Email" required="">
                                    </div>
    							</div>
    						</div>
    			    	</div>
    			        ...
    			        <div class="col-sm-6">
							<div class="form-group">
								<div class="controls">
                                   <div class="controls">
                                   <input type="number" name="phone" class="form-control" placeholder="Rider Phone" required="">
                                    </div>
    							</div>
    						</div>
    			    	</div>
    			        ...
    			        <div class="col-sm-6">
							<div class="form-group">
								<div class="controls">
                                   <div class="controls">
                                   <input type="text" value="demo1234" disabled name="password" class="form-control" placeholder="Rider Password" required="">
                                    </div>
    							</div>
    						</div>
    			    	</div>
       ...
       <!--                             </div>-->
    			...
    			<!--    	<div class="col-sm-6">-->
							...
							<!--	<div class="controls">-->
       <!--                            <div class="controls">-->
       <!--                            <input type="number" name="ProDiscount" class="form-control" placeholder="Discount (Optional)" >-->
       <!--                             </div>-->
    			<!--				</div>-->
    			<!--			</div>-->
    			<!--    	</div>-->
    			        ...
    			        <div class="col-sm-6">
							<div class="form-group">
								<div class="controls">
                                   <div class="controls">
                                   <input type="file" name="img" class="form-control" placeholder="Category Image" required="">
                                    </div>
    							</div>
    						</div>
    			    	</div>
                      ...
                      <div class="col-sm-12">
							...
							<button type="Submit" name="btnSubmit_insertuser"  class="btn btn-primary">Submit</button>
                     </div>            
