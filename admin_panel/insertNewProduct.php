                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        ...
                                        <form class="form-horizontal" action="phpfiles/insertions.php" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            ...
                                                            <select name="for_deal_only" id="for_deal_only" class="form-control" required>
                                                                ...
                                                                <option value="2">Only for Pos</option>
                                                                <option value="4">Only for Free</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
                                          ...
                                          <div id="extras_fields" class="col-12">
        ...
        <select name="free_addon_limit" id="freeAddonLimit" class="form-control">
            ...
            ?>
                                                ...
                                                <div id="dynamic_fields" class="col-md-12">
                                                    <h4 class="card-title">Product Schedule</h4>

                                                    <div class="row">
                                                     <div class="col-sm-6">
  <h6 class="card-content">Select Schedule</h6>

  <div class="form-group">
    <div class="controls">
      <select name="time_id" id="proTime" class="form-control">
        ...
        $sql = "SELECT id, timing_name, start_time, end_time 
                FROM product_timings 
                WHERE status = 'active'
        ...
        while($row = mysqli_fetch_assoc($execute)){
            echo '<option value="'.$row['id'].'">
                    '.$row['timing_name'].' ('.$row['start_time'].' - '.$row['end_time'].')
                  </option>';
        }
        ?>
...
$(document).ready(function () {
    ...
    function toggleExtras() {
        if ($('#for_deal_only').val() === '4') {
            $('#extras_fields :input').prop('disabled', true);
            $('#extras_fields').addClass('disabled');
        } else {
            $('#extras_fields :input').prop('disabled', false);
            $('#extras_fields').removeClass('disabled');
        }
    }
