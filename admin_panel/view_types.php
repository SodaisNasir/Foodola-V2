              ...
              <div class="col-12">
                ...
                <div class="breadcrumb-wrapper col-12">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">View Types
                    </li>
                  </ol>
                </div>
              </div>
                            ...
                            <table id="example" class="table">
                                ...
                                <tbody>
                                      ...
                                      while($row = mysqli_fetch_array($result)){
                                          ...
                                          echo "<td>{$sn}</td>";
                                          echo "<td  name='tittlename'>{$row['type_id']}</td>";
                                          echo "<td class='editable' contenteditable='false' data-field='type_title' name='subname'>{$row['type_title']}</td>";
                                          echo "<td><button class='btn btn-success save-btn' style='display:none;'>Save</button></td>";  
                                          echo "<td><a href='update_types.php?id={$row['type_id']}' ><button class='btn btn-primary'>Update</button></a></td>";
                                          echo "</tr>";
                                          $index++;
                                      }
         ...
         <form method="POST" action="phpfiles/insertions.php" enctype="multipart/form-data">
             ...
             <div class="col-sm-12">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    <div class="controls">
                        <input class="form-control"  value="" type="number" name="as_price" id="as_price" placeholder="Enter Addon Price" > 
                    </div>
                  </div>
