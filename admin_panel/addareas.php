                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-6">
                          <div class="form-group">
                            <div class="controls">
                              <div class="controls">
                                <input type="number" name="minorderprice" class="form-control" placeholder="Minimum order price" required="">
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                          <div class="controls">
                            <select name="branch_id" id="userSelect" class="form-control" required="">
                                  ...
                                  <?php
                                        ...
                                        if ($result->num_rows > 0) {
                                            while ($row = $result->fetch_assoc()) {
                                                echo "<option value='" . $row['id'] . "'>" . htmlspecialchars($row['name']) .' === '. htmlspecialchars($row['id']) . "</option>";
                                            }
                                        } else {
                        ...
                        <button type="submit" name="btnSubmit_insertAreas" class="btn btn-primary">Submit</button>
                    </form>
...
<script>
    ...
    $.ajax({
        url: 'https://foodola.foodola.shop/API/add_areas.php', // Or pass this via argument
        type: 'POST',
        data: formData,
        contentType: false,
        processData: false,
...
function downloadSampleCSV() {
    const headers = ["area_name", "min_order_amount", "branch_id"];
    const sampleData = [
        ["Downtown", "100", "1"],
        ["Uptown", "150", "2"],
        ["Midtown", "120", "3"]
