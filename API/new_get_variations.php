...
if($_POST['token'] == 'as23rlkjadsnlkcj23qkjnfsDKJcnzdfb3353ads54vd3favaeveavgbqaerbVEWDSC')
{
  ...
  $select = "SELECT `id`, `product_id`, `sub_title`, `var_id` FROM `variation_with_product` WHERE product_id =  $product_id";
  ...
  if($rows > 0)
  {
         while($var_arr = mysqli_fetch_array($execute))
         {
             ...
             p.created_at FROM variation_with_product vp INNER JOIN products p on p.id = vp.product_id WHERE vp.var_id = $var_id";
                 ...
                 while($ar_var_with_pro = mysqli_fetch_array($exec_var_with_pro))
                 {
                     ...
                     if($exec_select_adon)
                     {
                          while($ar_select_adon = mysqli_fetch_array($exec_select_adon))
                          {
                              ...
                              [
                                  ...
                                  "addons"=>$ar_select_adon['ao_title'],
                              ];
                          }
                     ...
                     [
                            "variation_id"=>$ar_var_with_pro['variation_id'],
                             ...
                             "name"=>$ar_var_with_pro['product_name'],
