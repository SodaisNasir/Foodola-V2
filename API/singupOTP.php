...
$mail->Username = 'boundedsocial@gmail.com'; 
        ...
        $mail->isHTML(true);
        $mail->Subject = "Your OTP for Pizza Blitz";
                    ...
                    <tr>
                        <td align="center">
                            <table width="100%" class="content" style="max-width: 600px;">
                                <tr>
                                    <td align="center">
                                        <img src="https://xn--pizzablitzstringen-m3b.de/pizza_blitz/admin_panel/images/logo.png" alt="Broad Way Pizza" style="width: 100px; margin-bottom: 20px;">
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        ...
                                        <p>Best regards,<br>The Pizza Blitz Team</p>
                                    </td>
                                </tr>
                            </table>
                        </td>
