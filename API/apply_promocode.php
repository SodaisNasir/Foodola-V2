...
if (mysqli_query($conn, $update_sql)) {
    ...
    if (mysqli_query($conn, $insert_usage)) {
        ...
        $sql = "INSERT INTO `tbl_transaction`(`user_id`, `transaction_id`, `amount`, `type`, `message`, `english_message`) VALUES ('$user_id','$rand_id','$promo_value','credit','$transaction_message', '$english_message')";
