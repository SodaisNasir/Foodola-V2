  ...
  if ($tbl_id) {
          ...
          echo json_encode(array("statusCode" => 200, "message" => "Order created successfully", "order_id" => $last_order_id));
            ...
            $order_info = [
             ...
             try {
                    ...
                    $channel = 'pizzasofort_orders'; // Channel name dynamically based on user ID
                    $event   = 'new_order';
                    $data    = [
                ...
                $mail = new PHPMailer(true);
                    ...
                    try {
                                ...
                                $mail->addAddress('pizzasofort.ka@gmail.com');
                        
                                $mail->isHTML(true);
                                
                                $mail->Subject = "Neue Bestellung #$last_order_id – Pizza Sofort";
                                ...
                                <body>
                                    <div class="email-container">
                                        <div class="header">
                                            <img src="https://pizzasofort-ka.de/admin_panel/images/logo.png" alt="Pizza Sofort" style="width: 100px;">
                                        ...
                                        <div class="order-details">
                                            ...
                                            <a class="view-button" href="https://pizzasofort-ka.de/admin_panel/order_details.php?order_id=' . $last_order_id . '" target="_blank">Bestellung anzeigen</a>
                                        </div>
                                        <div class="footer">
                                            <p>Diese E-Mail wurde automatisch von Pizza Sofort generiert.</p>
                                        </div>
                                    </div>
                                </body>
                                </html>';
    ...
    $address = $Shipping_address . " " . $Shipping_address_2 . " " . $Shipping_city . " " . $Shipping_area . " " . $Shipping_state . " " . $Shipping_postal_code;
         ...
         try {
                    ...
                    // prepare notification
                    $channel = 'pizzasofort_orders'; // Channel name 
                    $event   = 'new_order';
                    $data    = [
                        'order_id' => $last_order_id,
                        'order_data'  => $order_info,
