             ...
             try {
                   ...
                   $mail = new PHPMailer(true);
                    ...
                    try {
                                ...
                                $mail->Subject = "Neue Bestellung #$last_id – Pizza Burger Point";
                                ...
                                <body>
                                    <div class="email-container">
                                        <div class="header">
                                            <img src="https://burgerpoint.shop/BurgerPoint/admin_panel/images/logo.png" alt="Pizza Burger Point" style="width: 100px;">
                                        ...
                                        <div class="order-details">
                                            ...
                                            <a class="view-button" href="https://burgerpoint.shop/BurgerPoint/admin_panel/order_details.php?order_id=' . $last_order_id . '" target="_blank">Bestellung anzeigen</a>
                                        </div>
                                        <div class="footer">
                                            <p>Diese E-Mail wurde automatisch von Pizza Burger Point generiert.</p>
                                        </div>
                                    </div>
                                </body>
                                </html>';
