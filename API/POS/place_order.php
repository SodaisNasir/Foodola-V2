  ...
  if ($tbl_id) {
            ...
            $order_info = [
             ...
             try {
                ...
                try {
                                ...
                                $mail->Subject = "Neue Bestellung #$last_order_id – Burger Planet";
                                ...
                                <body>
                                    <div class="email-container">
                                        <div class="header">
                                            <img src="http://burgerplanet-ka.de/admin_panel/images/logo.png" alt="Burger Planet" style="width: 100px;">
                                        ...
                                        <div class="order-details">
                                            ...
                                            <a class="view-button" href="http://burgerplanet-ka.de/admin_panel/order_details.php?order_id=' . $last_order_id . '" target="_blank">Bestellung anzeigen</a>
                                        </div>
                                        <div class="footer">
                                            <p>Diese E-Mail wurde automatisch von Burger Planet generiert.</p>
                                        </div>
                                    </div>
                                </body>
                                </html>';
    ...
    $address = $Shipping_address . " " . $Shipping_address_2 . " " . $Shipping_city . " " . $Shipping_area . " " . $Shipping_state . " " . $Shipping_postal_code;
         ...
         try {
                    ...
                    // prepare notification
                    $channel = 'burgerplanet_orders'; // Channel name 
                    $event   = 'new_order';
                    $data    = [
                        'order_id' => $last_order_id,
                        'order_data'  => $order_info,
