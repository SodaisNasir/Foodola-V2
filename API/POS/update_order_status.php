                                ...
                                <tr>
                                    <td align="center">
                                        <table width="100%" class="content" style="max-width: 600px;">
                                            <tr>
                                                <td align="center">
                                                    <img src="https://pizzatime.foodola.shop/admin_panel/images/logo.png" alt="Pizza Burger Point" style="width: 100px; margin-bottom: 20px;">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                ...
                                <table width="100%" class="content" style="max-width: 600px;">
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <p><strong>Bestellnummer:</strong> #' . htmlspecialchars($order_id) . '</p>
                                            <h3>Guten Appetit!</h3>
                                            <p>Wir hoffen, dass Sie Ihr Essen genießen. Vielen Dank, dass Sie bei <strong>Pizza Time</strong> bestellt haben.</p>
