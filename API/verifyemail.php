...
if ($_POST['token'] == 'as23rlkjadsnlkcj23qkjnfsDKJcnzdfb3353ads54vd3favaeveavgbqaerbVEWDSC') {
    ...
    if (mysqli_num_rows($execute) > 0) {
        ...
        $subject = 'Your OTP for Indian Rasoi';
      $message = '
<html>
<head>
...
<body>
    <table width="100%" cellpadding="0" cellspacing="0" style="background-image: url(\'https://indianrasoi.sassolution.org/API/uploads/email_backgroundd.jpg\'); background-size: cover; padding: 20px; background-position: center;">
        <tr>
            <td align="center">
                <table class="content">
                    ...
                    <tr>
                        <td>
                            <h1>Your OTP for Indian Rasoi</h1>
                            ...
                            <p class="footer">Best regards,<br>The Indian Rasoi Team</p>
                        </td>
                    </tr>
                </table>
            </td>
        ...
        $headers = "From: support@indianrasoi.de\r\n";
        $headers .= "Reply-To: support@indianrasoi.de\r\n";
