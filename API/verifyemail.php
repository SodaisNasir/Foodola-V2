...
if ($_POST['token'] == 'as23rlkjadsnlkcj23qkjnfsDKJcnzdfb3353ads54vd3favaeveavgbqaerbVEWDSC') {
    ...
    if (mysqli_num_rows($execute) > 0) {
        ...
        $subject = 'Your OTP for Pizza Blitz';
      $message = '
<html>
<head>
    <title>Your OTP for Pizza Blitz</title>
...
<body>
    <table width="100%" cellpadding="0" cellspacing="0" style="background-image: url(\'https://xn--pizzablitzstringen-m3b.de/pizza_blitz/API/uploads/email_backgroundd.jpg\'); background-size: cover; padding: 20px; background-position: center;">
        <tr>
            <td align="center">
                <table class="content">
                    ...
                    <tr>
                        <td>
                            <h1>Your OTP for Pizza Blitz</h1>
        ...
        $headers = "From: support@pizzablitz.de\r\n";
        $headers .= "Reply-To: support@pizzablitz.de\r\n";
