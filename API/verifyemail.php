...
if ($_POST['token'] == 'as23rlkjadsnlkcj23qkjnfsDKJcnzdfb3353ads54vd3favaeveavgbqaerbVEWDSC') {
    ...
    if (mysqli_num_rows($execute) > 0) {
        ...
        $subject = 'Your OTP for Namaste India';
      $message = '
<html>
<head>
    <title>Your OTP for Namaste India</title>
...
<body>
    <table width="100%" cellpadding="0" cellspacing="0" style="background-image: url(\'https://namasteindia.foodola.shop/API/uploads/email_backgroundd.jpg\'); background-size: cover; padding: 20px; background-position: center;">
        <tr>
            <td align="center">
                <table class="content">
                    ...
                    <tr>
                        <td>
                            <h1>Your OTP for Namaste India</h1>
                            ...
                            <p class="footer">Best regards,<br>The Namaste India Team</p>
                        </td>
                    </tr>
                </table>
            </td>
        ...
        $headers = "From: support@namasteindiaruchsal\r\n";
        $headers .= "Reply-To: support@namasteindiaruchsal\r\n";
