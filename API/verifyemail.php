...
if ($_POST['token'] == 'as23rlkjadsnlkcj23qkjnfsDKJcnzdfb3353ads54vd3favaeveavgbqaerbVEWDSC') {
    ...
    if (mysqli_num_rows($execute) > 0) {
        ...
        $subject = 'Your OTP for Pizza Time';
      $message = '
<html>
<head>
...
<body>
    <table width="100%" cellpadding="0" cellspacing="0" style="background-image: url(\'https://pizzatime.foodola.shop/API/uploads/email_backgroundd.jpg\'); background-size: cover; padding: 20px; background-position: center;">
                ...
                <table class="content">
                    ...
                    <tr>
                        <td>
                            ...
                            <p class="footer">Best regards,<br>The Pizza Time Team</p>
                        </td>
                    </tr>
                </table>
            </td>
        ...
        $headers = "From: support@pizzatime.de\r\n";
        $headers .= "Reply-To: support@pizzatime.de\r\n";
