            ...
            if ($exec_sql_ins) {
                ...
                $mail = new PHPMailer(true);
                    ...
                    try {
                                ...
                                $mail->Subject = "Neue Bestellung #$last_id – Burger Planet";
                                ...
                                <body>
                                    <div class="email-container">
                                        ...
                                        <div class="order-details">
                                            ...
                                            <a class="view-button" href="http://burgerplanet-ka.de/admin_panel/order_details.php?order_id=' . $last_id . '" target="_blank">Bestellung anzeigen</a>
                                        </div>
                                        <div class="footer">
                                            <p>Diese E-Mail wurde automatisch von Pizza Burger Planet generiert.</p>
                                        </div>
                                    </div>
                                </body>
                                </html>';
