            ...
            if ($exec_sql_ins) {
                ...
                if ($exec_sql_deal) {
                    ...
                    try {
                                ...
                                $mail->Subject = "Neue Bestellung #$last_id – Pizza Blitz";
                                ...
                                <body>
                                    <div class="email-container">
                                        ...
                                        <div class="order-details">
                                            ...
                                            <a class="view-button" href="https://xn--pizzablitzstringen-m3b.de/pizza_blitz/admin_panel/order_details.php?order_id=' . $last_id . '" target="_blank">Bestellung anzeigen</a>
                                        </div>
                                        <div class="footer">
