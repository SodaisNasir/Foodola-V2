                ...
                if ($exec_sql_deal) {
                   // Send notification to user (already done)
                    ...
                    try {
                                ...
                                $mail->Subject = "Neue Bestellung #$last_id – Pizza Time";
                                ...
                                <body>
                                    <div class="email-container">
                                        ...
                                        <div class="order-details">
                                            ...
                                            <a class="view-button" href="https://pizzatime.foodola.shop/BurgerPoint/admin_panel/order_details.php?order_id=' . $last_id . '" target="_blank">Bestellung anzeigen</a>
                                        </div>
                                        <div class="footer">
