                ...
                if ($exec_sql_deal) {
                   // Send notification to user (already done)
                    ...
                    try {
                        ...
                        $channel = 'jbpizza_orders'; // Channel name dynamically based on user ID
                        $event   = 'new_order';
                        $data    = [
                            'order_id' => $last_id,
                    ...
                    try {
                                ...
                                $mail->Subject = "Neue Bestellung #$last_id – Jb Pizza";
                                ...
                                <body>
                                    <div class="email-container">
                                        <div class="header">
                                            <img src="https://jbpizza.foodola.shop/admin_panel/images/logo.png" alt="Jb Pizza" style="width: 100px;">
                                        ...
                                        <div class="order-details">
                                            ...
                                            <a class="view-button" href="https://jbpizza.foodola.shop/admin_panel/order_details.php?order_id=' . $last_id . '" target="_blank">Bestellung anzeigen</a>
                                        </div>
                                        <div class="footer">
                                            <p>Diese E-Mail wurde automatisch von Jb Pizza generiert.</p>
                                        </div>
                                    </div>
                                </body>
                                </html>';
                    ...
                    try {
                                ...
                                <body>
                                    <div class="email-container">
                                        ...
                                        <div class="footer">
                                            <p>Diese E-Mail wurde automatisch von jbpizza generiert.</p>
                                        </div>
                                    </div>
                                </body>
                                </html>';
