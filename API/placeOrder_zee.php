                ...
                if ($exec_sql_deal) {
                   // Send notification to user (already done)
                    ...
                    try {
                                ...
                                $mail->Subject = "Neue Bestellung #$last_id – Food Vibe";
                                ...
                                <body>
                                    <div class="email-container">
                                        <div class="header">
                                            <img src="https://foodvibeka.de/admin_panel/images/logo.png" alt="food vibe" style="width: 100px;">
                                        ...
                                        <div class="order-details">
                                            ...
                                            <a class="view-button" href="https://foodvibeka.de/admin_panel/order_details.php?order_id=' . $last_id . '" target="_blank">Bestellung anzeigen</a>
                                        </div>
                                        <div class="footer">
                                            <p>Diese E-Mail wurde automatisch von Food Vibe generiert.</p>
                                        </div>
                                    </div>
                                </body>
                                </html>';
