    ...
    if ($payment_type == 'online') {
        ...
        if (mysqli_num_rows($r_check) == 0) {
            $sql_ins = "INSERT INTO `orders_zee`(`user_id`, `status`, `payment_type`,
                ...
                `Shipping_state`, `addtional_notes` , `created_at`  , `payment_method` , `transaction_id` , `order_type` , `ordersheduletype` , `sheduletime` , `total_discount`, `branch_id`, `total_netto_tax`, `total_metto_tax`, `platform`) VALUES 
                ('$user_id','neworder','$payment_type','$order_total_price','$payment_status','$Shipping_address',
                  ...
                  '$Shipping_state','$addtional_notes' , '$datetime' , '$payment_method' , '$transaction_id' , '$order_type' , '$ordersheduletype','$sheduletime' , '$total_discount', '$branch_id', '$total_metto_tax', '$total_metto_tax', '$platform')";
...
if ($order_result) {
    ...
    $order_info = [
        ...
        $sql_ins = "INSERT INTO `orders_zee`(`user_id`, `status`, `payment_type`,
                `order_total_price`, `payment_status`, `Shipping_address`, `Shipping_address_2`,
                `Shipping_city`, `Shipping_area`, `Shipping_postal_code`, `Shipping_Cost`,
                `Shipping_state`, `addtional_notes` , `created_at`  ,  `order_type`  , `ordersheduletype` , `sheduletime` , `total_discount`, `branch_id`, `total_netto_tax`, `total_metto_tax`, `platform`) VALUES 
                ('$user_id','neworder','$payment_type','$order_total_price','$payment_status','$Shipping_address',
                  '$Shipping_address_2','$Shipping_city','$Shipping_area','$Shipping_postal_code','$Shipping_cost',
                  '$Shipping_state','$addtional_notes' , '$datetime' , '$order_type', '$ordersheduletype','$sheduletime' , '$total_discount', '$branch_id', '$total_netto_tax', '$total_metto_tax', '$platform')";
        $exec_sql_ins = mysqli_query($conn, $sql_ins);
