...
if ($_POST['token'] === 'as23rlkjadsnlkcj23qkjnfsDKJcnzdfb3353ads54vd3favaeveavgbqaerbVEWDSC') {
    ...
    $mail->Username = 'boundedsocial@gmail.com'; 
        ...
        $mail->setFrom('support@pizzaredpeppers.de', 'Pizza Red Peppers');
        $mail->addAddress($email); 

        $mail->isHTML(true);
        $mail->Subject = "Welcome to Pizza Red Peppers";
            ...
            if ($result) {
                ...
                if ($ex_getdata) {
                    $Data = mysqli_fetch_array($ex_getdata);
                            ...
                            <html>
                            <head>
                                <title>Welcome to Pizza Red Peppers !</title>
                            ...
                            <body>
                                <table width="100%" cellpadding="0" cellspacing="0" style="background-image: url(\'https://pizzaredpeppersneckarsulm.de/API/uploads/email_backgroundd.jpg\'); background-size: cover; padding: 20px; background-position: center;">
                                    <tr>
                                        <td align="center">
                                            <table width="100%" class="content" style="max-width: 600px;">
                                                <tr>
                                                    <td align="center">
                                                        <!-- Logo Section -->
                                                        <img src="https://pizzaredpeppersneckarsulm.de/admin_panel/images/logo.png" alt="Pizza Red Peppers Logo" style="width: 100px; margin-bottom: 20px;">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                         <h1>Welcome, ' . htmlspecialchars($name) . '!</h1>
                                                        <p>Thank you for joining Pizza Red Peppers! We’re thrilled to welcome you to our community of pizza and burger lovers.</p>
                                                        <h3>Why You’ll Love Pizza Red Peppers:</h3>
                                                        <ul>
                                                        ...
                                                        <div class="social-icons">
                                                            <a href="https://facebook.com/pizzaredpeppers" target="_blank">
                                                                <img src="https://pizzaredpeppersneckarsulm.de/API/uploads/facebook_logo.png" alt="Facebook">
                                                            </a>
                                                            <a href="https://instagram.com/pizzaredpeppers" target="_blank">
                                                                <img src="https://pizzaredpeppersneckarsulm.de/API/uploads/instagram_logo.png" alt="Instagram">
                                                            </a>
                                                            <a href="https://twitter.com/pizzaredpeppers" target="_blank">
                                                                <img src="https://pizzaredpeppersneckarsulm.de/API/uploads/twitter_logo.png" alt="Twitter">
                                                            </a>
                                                        </div>
                                                        <p>Enjoy every bite!</p>
                                                        <p>Warm regards,<br><strong>The Pizza Red Peppers Team</strong></p>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
