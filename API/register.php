...
if ($_POST['token'] === 'as23rlkjadsnlkcj23qkjnfsDKJcnzdfb3353ads54vd3favaeveavgbqaerbVEWDSC') {
    ...
    try {
        ...
        $mail->setFrom('support@burgerpointgarben.de', 'Burger Point Graben');
        $mail->addAddress($email); 

        $mail->isHTML(true);
        $mail->Subject = "Welcome to Burger Point Graben";
            ...
            if ($result) {
                ...
                if ($ex_getdata) {
                    $Data = mysqli_fetch_array($ex_getdata);
                            ...
                            <html>
                            <head>
                                <title>Welcome to Burger Point Graben !</title>
                                        ...
                                        <td align="center">
                                            <table width="100%" class="content" style="max-width: 600px;">
                                                <tr>
                                                    <td align="center">
                                                        <!-- Logo Section -->
                                                        <img src="https://burgerpointgraben.de/admin_panel/images/logo.png" alt="Pizza Burger Point Logo" style="width: 100px; margin-bottom: 20px;">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                         <h1>Welcome, ' . htmlspecialchars($name) . '!</h1>
                                                        <p>Thank you for joining Burger Point Graben! We’re thrilled to welcome you to our community of pizza and burger lovers.</p>
                                                        <h3>Why You’ll Love Burger Point Graben :</h3>
                                                        <ul>
                                                        ...
                                                        <ul>
                                                            <li>👀 <a href="https://burgerpointgraben.de/menu">Browse our Menu</a> and find your favorites.</li>
                                                        ...
                                                        <div class="social-icons">
                                                            <a href="https://facebook.com/burgerpointgarben" target="_blank">
                                                                <img src="https://burgerpointgraben.de/API/uploads/facebook_logo.png" alt="Facebook">
                                                            </a>
                                                            <a href="https://instagram.com/burgerpointgarben" target="_blank">
                                                                <img src="https://burgerpointgraben.de/API/uploads/instagram_logo.png" alt="Instagram">
                                                            </a>
                                                            <a href="https://twitter.com/burgerpointgarben" target="_blank">
                                                                <img src="https://burgerpointgraben.de/API/uploads/twitter_logo.png" alt="Twitter">
                                                            </a>
                                                        </div>
                                                        <p>Enjoy every bite!</p>
                                                        <p>Warm regards,<br><strong>The Burger Point Graben Team</strong></p>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
