...
if ($_POST['token'] === 'as23rlkjadsnlkcj23qkjnfsDKJcnzdfb3353ads54vd3favaeveavgbqaerbVEWDSC') {
    ...
    try {
     ...
     $mail->Username = 'boundedsocial@gmail.com'; 
        ...
        $mail->setFrom('support@pizzasofort.de', 'Pizza Sofort');
        $mail->addAddress($email); 

        $mail->isHTML(true);
        $mail->Subject = "Welcome to Pizza Sofort";
            ...
            if ($result) {
                ...
                if ($ex_getdata) {
                    $Data = mysqli_fetch_array($ex_getdata);
                            ...
                            <html>
                            <head>
                                <title>Welcome to Pizza Sofort !</title>
                            ...
                            <body>
                                <table width="100%" cellpadding="0" cellspacing="0" style="background-image: url(\'https://pizzasofort-ka.de/API/uploads/email_backgroundd.jpg\'); background-size: cover; padding: 20px; background-position: center;">
                                    <tr>
                                        <td align="center">
                                            <table width="100%" class="content" style="max-width: 600px;">
                                                <tr>
                                                    <td align="center">
                                                        <!-- Logo Section -->
                                                        <img src="https://pizzasofort-ka.de/admin_panel/images/logo.png" alt="Pizza Sofort Logo" style="width: 100px; margin-bottom: 20px;">
                                                    </td>
                                                </tr>
                                                <tr>
                                                   <td>
                                                        <h1>Willkommen bei Pizza Sofort – Dein Genuss startet jetzt! 🍕🎉</h1>
                                                        <p>Hallo ' . htmlspecialchars($name) . ',</p>
                                                        <p>herzlich willkommen bei Pizza Sofort! 🥳<br>
                                                        Schön, dass du da bist – wir freuen uns riesig, dich in unserer Community von Pizza- und Burgerliebhabern zu begrüßen.</p>
                                                
                                                        <h3>Warum du Pizza Sofort lieben wirst:</h3>
                                                        <ul>
                                                        ...
                                                        <ul>
                                                            <li>👀 <a href="https://pizzasofort-ka.de/">Entdecke unsere Speisekarte</a> und finde deine Favoriten</li>
                                                        ...
                                                        <div class="social-icons">
                                                            <a href="https://facebook.com/pizzasofort" target="_blank">
                                                                <img src="https://pizzasofort-ka.de/API/uploads/facebook_logo.png" alt="Facebook">
                                                            </a>
                                                            <a href="https://instagram.com/pizzasofort" target="_blank">
                                                                <img src="https://pizzasofort-ka.de/API/uploads/instagram_logo.png" alt="Instagram">
                                                            </a>
                                                            <a href="https://twitter.com/pizzasofort" target="_blank">
                                                                <img src="https://pizzasofort-ka.de/API/uploads/twitter_logo.png" alt="Twitter">
                                                            </a>
                                                        </div>
                                                
                                                        <p>Guten Appetit & viel Spaß beim Genießen!<br><strong>Dein Pizza Sofort Team 🍕</strong></p>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
