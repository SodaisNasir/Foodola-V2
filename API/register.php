...
if ($_POST['token'] === 'as23rlkjadsnlkcj23qkjnfsDKJcnzdfb3353ads54vd3favaeveavgbqaerbVEWDSC') {
    ...
    try {
     ...
     $mail->Username = 'boundedsocial@gmail.com'; 
        ...
        $mail->isHTML(true);
        $mail->Subject = "Welcome to Himalaya Spicy";
            ...
            if ($result) {
                ...
                if ($ex_getdata) {
                    $Data = mysqli_fetch_array($ex_getdata);
                            ...
                            <html>
                            <head>
                                <title>Welcome to Himalaya Spicy !</title>
                                    ...
                                    <tr>
                                        <td align="center">
                                            <table width="100%" class="content" style="max-width: 600px;">
                                                ...
                                                <tr>
                                                   <td>
                                                        <h1>Willkommen bei Himalaya Spicy – Dein Genuss startet jetzt! 🍕🎉</h1>
                                                        <p>Hallo ' . htmlspecialchars($name) . ',</p>
                                                        <p>herzlich willkommen bei Himalaya Spicy! 🥳<br>
                                                        Schön, dass du da bist – wir freuen uns riesig, dich in unserer Community von Pizza- und Burgerliebhabern zu begrüßen.</p>
                                                
                                                        <h3>Warum du Himalaya Spicy lieben wirst:</h3>
                                                        <ul>
                                                        ...
                                                        <ul>
                                                            <li>👀 <a href="https://himalayaspicy.foodola.shop/">Entdecke unsere Speisekarte</a> und finde deine Favoriten</li>
                                                        ...
                                                        <div class="social-icons">
                                                            <a href="https://facebook.com/himalayaspicy" target="_blank">
                                                                <img src="https://himalayaspicy.foodola.shop/API/uploads/facebook_logo.png" alt="Facebook">
                                                            </a>
                                                            <a href="https://instagram.com/himalayaspicy" target="_blank">
                                                                <img src="https://himalayaspicy.foodola.shop/API/uploads/instagram_logo.png" alt="Instagram">
                                                            </a>
                                                            <a href="https://twitter.com/himalayaspicy" target="_blank">
                                                                <img src="https://himalayaspicy.foodola.shop/API/uploads/twitter_logo.png" alt="Twitter">
                                                            </a>
                                                        </div>
                                                
                                                        <p>Guten Appetit & viel Spaß beim Genießen!<br><strong>Dein Himalaya Spicy Team 🍕</strong></p>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
