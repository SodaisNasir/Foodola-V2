...
if ($_POST['token'] === 'as23rlkjadsnlkcj23qkjnfsDKJcnzdfb3353ads54vd3favaeveavgbqaerbVEWDSC') {
    ...
    try {
        ...
        $mail->setFrom('support@foodola.de', 'Food Vibe');
        $mail->addAddress($email); 

        $mail->isHTML(true);
        $mail->Subject = "Welcome to Food Vibe";
            ...
            if ($result) {
                ...
                if ($ex_getdata) {
                    $Data = mysqli_fetch_array($ex_getdata);
                            ...
                            <html>
                            <head>
                                <title>Welcome to Food Vibe !</title>
                                        ...
                                        <td align="center">
                                            <table width="100%" class="content" style="max-width: 600px;">
                                                <tr>
                                                    <td align="center">
                                                        <!-- Logo Section -->
                                                        <img src="https://foodvibeka.de/admin_panel/images/logo.png" alt="Pizza Burger Point Logo" style="width: 100px; margin-bottom: 20px;">
                                                    </td>
                                                </tr>
                                                <tr>
                                                   <td>
                                                        <h1>Willkommen bei Food Vibe – Dein Genuss startet jetzt! 🍕🎉</h1>
                                                        <p>Hallo ' . htmlspecialchars($name) . ',</p>
                                                        <p>herzlich willkommen bei Food Vibe! 🥳<br>
                                                        Schön, dass du da bist – wir freuen uns riesig, dich in unserer Community von Pizza- und Burgerliebhabern zu begrüßen.</p>
                                                
                                                        <h3>Warum du Food Vibe lieben wirst:</h3>
                                                        <ul>
                                                        ...
                                                        <ul>
                                                            <li>👀 <a href="https://foodvibeka.de">Entdecke unsere Speisekarte</a> und finde deine Favoriten</li>
                                                        ...
                                                        <div class="social-icons">
                                                            <a href="https://facebook.com/foodvibeka" target="_blank">
                                                                <img src="https://foodvibeka.de/API/uploads/facebook_logo.png" alt="Facebook">
                                                            </a>
                                                            <a href="https://instagram.com/foodvibeka" target="_blank">
                                                                <img src="https://foodvibeka.de/API/uploads/instagram_logo.png" alt="Instagram">
                                                            </a>
                                                            <a href="https://twitter.com/foodvibeka" target="_blank">
                                                                <img src="https://foodvibeka.de/API/uploads/twitter_logo.png" alt="Twitter">
                                                            </a>
                                                        </div>
                                                
                                                        <p>Guten Appetit & viel Spaß beim Genießen!<br><strong>Dein Food Vibe Team 🍕</strong></p>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
