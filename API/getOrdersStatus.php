...
if($_POST['token'] == 'as23rlkjadsnlkcj23qkjnfsDKJcnzdfb3353ads54vd3favaeveavgbqaerbVEWDSC'){
  ...
  if($status == 'current_orders'){
    ...
    $sql = "SELECT ordersss.id, ordersss.user_id,ordersss.status,ordersss.order_total_price,ordersss.payment_type,ordersss.Shipping_address,ordersss.Shipping_address_2,ordersss.Shipping_city,ordersss.Shipping_area,ordersss.Shipping_state,ordersss.Shipping_postal_code,
    ordersss.Shipping_Cost,ordersss.addtional_notes,ordersss.addtional_notes
      FROM `orders` AS ordersss  WHERE `user_id` =  $user_id AND `status` = 'pending' OR `user_id` =  $user_id AND `status` = 'neworder' OR `user_id` =  $user_id AND `status` = 'shipped'";
    ...
    $sql = "SELECT ordersss.id, ordersss.user_id,ordersss.status,ordersss.order_total_price,ordersss.payment_type,ordersss.Shipping_address,ordersss.Shipping_address_2,ordersss.Shipping_city,ordersss.Shipping_area,ordersss.Shipping_state,ordersss.Shipping_postal_code,
    ordersss.Shipping_Cost,ordersss.addtional_notes,ordersss.addtional_notes WHERE `user_id` =  $user_id AND `status` = 'delivered'";
