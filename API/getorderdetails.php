...
if($_POST['token'] == 'as23rlkjadsnlkcj23qkjnfsDKJcnzdfb3353ads54vd3favaeveavgbqaerbVEWDSC'){
    ...
    $sql = "SELECT order_details_zee.product_id , orders_zee.Shipping_Cost,  products.name, products.description, products.discount ,order_details_zee.addons, order_details_zee.qty , order_details_zee.cost , order_details_zee.product_name, order_details_zee.price, `img`  FROM `order_details_zee` INNER JOIN products ON products.id = order_details_zee.product_id INNER JOIN orders_zee ON orders_zee.id = order_details_zee.order_id WHERE order_details_zee.order_id = $order_id";
